  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <img class="img-fluid modalImg" src="https://cdn.pixabay.com/photo/2020/05/22/08/17/breakfast-5204352_960_720.jpg" alt='Loading...'/>     
      </div>
      ...
      <button type="button" class="btn btn-warning m-3">Add to Cart{' '}{`(${totalItems})`}</button>
    </div>
  </div>
</div>
</>
